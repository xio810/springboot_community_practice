...
<%@ page import="com.xio.exam.community.util.Ut"%>
  ...
  <div class="container mx-auto">
    <form method="POST" action="../member/doJoin" onsubmit="MemberJoin__submitForm(this); return false;">
      <div class="form-control">
        ...
        <input class="input input-bordered w-full" type="text" maxlength="30" name="loginId"
          placeholder="로그인아이디를 입력해주세요." />
      </div>

      <div class="form-control">
        <label class="label"> 로그인비밀번호 </label>
        <input class="input input-bordered w-full" type="password" maxlength="30" name="loginPw"
          placeholder="로그인비밀번호를 입력해주세요." />
      </div>

      <div class="form-control">
        <label class="label"> 로그인비밀번호 확인 </label>
        <input class="input input-bordered w-full" type="password" maxlength="30" name="loginPwConfirm"
      ...
      <div class="form-control">
        ...
        <input class="input input-bordered w-full" type="tel" maxlength="30" name="cellphoneNo"
      ...
      <div class="mt-4 btn-wrap gap-1">
        <button type="submit" href="/usr/member/doJoin" class="btn btn-primary btn-sm mb-1">
          <span>
